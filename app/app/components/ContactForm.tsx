			...
			<fetcher.Form action="/contact-us-route" className="flex w-full flex-wrap sm:mx-auto sm:items-end" method="post">
				...
				<div className="mb-8 w-full">
					...
					<textarea
						className={
							fetcher.state === 'submitting'
								? 'text-md mt-2 box-border inline-flex h-20 w-full items-center justify-center rounded-xl bg-gray-50/50 pl-2 focus:outline-none'
				...
				<div className="mb-4 flex items-center">
					<input
						type="checkbox"
						className={fetcher.state === 'submitting' ? 'mr-4' : 'mr-4'}
						value="true"
						defaultValue={'false'}
						name="checked"
					/>
