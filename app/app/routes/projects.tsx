    ...
    <div className="px-8 sm:max-w-screen-lg sm:mx-auto">
      ...
      <section className="mb-4 sm:mb-20">
        <div className="pb-4 border-b-2 border-black sm:pb-16">
          ...
          <select className="inline-flex items-center justify-center text-md h-10 pl-2 mt-2 sm:h-14 box-border rounded-xl w-full focus:outline-none" defaultValue={optimisticProjectId} id="uuid" name="uuid">
