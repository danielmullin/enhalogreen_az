...
export async function authenticate (request) {
  ...
  const cognitoUrl = `https://${String(cognitoDomain)}/login?client_id=${String(cognitoClientId)}&response_type=code&scope=email+openid&redirect_uri=${String(redirectUri)}&state=${redirectTo}`;
  let user = null;
