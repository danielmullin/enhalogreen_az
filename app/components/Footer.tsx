...
export default function Footer(): JSX.Element {
	return (
		<footer className="min-h-20 w-full bg-black text-base text-white sm:min-h-10">
			<div className="m-auto min-h-20 max-w-960 flex-wrap justify-between sm:flex sm:min-h-10 sm:items-center">
				<div className="py-8">
					<ul id="id" className="flex px-4">
						...
						<li id="menu-item-91" className="">
							<Link to="https://www.linkedin.com/" className="text-black">
								<svg
									className="h-10 w-10 rounded-full border bg-white p-1"
									fill="currentColor"
									viewBox="0 0 24 24"
