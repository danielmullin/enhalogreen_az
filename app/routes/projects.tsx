				...
				<div className='border-b-2 border-black pb-4 sm:pb-16'>
					...
					>
						{subProjects.map((subProject: SubProject) => (
							<option key={subProject.uuid} value={subProject.uuid}>
								{subProject.name}
							</option>
						))}
					</select>
				...
				<div className='border-b-2 border-black pb-6 sm:pb-16'>
					<div className='sm:flex sm:items-center'>
						...
						<div className='sm:w-2/5 sm:text-right'>
							<Cta linkTo={`/offset-products?subProjectId=${optimisticProjectId}`} text={content.cta.offsetYourProducts} type='primary' />
						</div>
					</div>
				</div>
			</section>
